...
namespace aim.FullSerializer.Internal {
    ...
    public class fsWeakReferenceConverter : fsConverter {
        ...
        public override fsResult TrySerialize(object instance, out fsData serialized, Type storageType, object other) {
            ...
            if (weakRef.IsAlive) {
                fsData data;
                if ((result += Serializer.TrySerialize(weakRef.Target, out data, other)).Failed) {
                    return result;
                }
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType, object other) {
            ...
            if (data.AsDictionary.ContainsKey("Target")) {
                ...
                if ((result += Serializer.TryDeserialize(targetData, typeof(object), ref targetInstance, other)).Failed) return result;
