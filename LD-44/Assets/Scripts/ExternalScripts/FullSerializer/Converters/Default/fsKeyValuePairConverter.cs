...
namespace aim.FullSerializer.Internal
{
    public class fsKeyValuePairConverter : fsConverter
    {
        ...
        public override fsResult TryDeserialize(fsData data, ref object instance, Type storageType, object other)
        {
            ...
            result.AddMessages(Serializer.TryDeserialize(keyData, keyType, ref keyObject, other));
            result.AddMessages(Serializer.TryDeserialize(valueData, valueType, ref valueObject, other));
        ...
        public override fsResult TrySerialize(object instance, out fsData serialized, Type storageType, object other)
        {
            ...
            fsData keyData, valueData;
            result.AddMessages(Serializer.TrySerialize(keyType, keyObject, out keyData, other));
            result.AddMessages(Serializer.TrySerialize(valueType, valueObject, out valueData, other));
