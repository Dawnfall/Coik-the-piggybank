...
namespace aim.FullSerializer.Internal {
    public class fsSerializationCallbackProcessor : fsObjectProcessor {
        ...
        public override void OnBeforeSerialize(Type storageType, object instance, object other) {
            // Don't call the callback on null instances.
            if (instance == null) return;
            ((fsISerializationCallbacks)instance).OnBeforeSerialize(storageType);
        }

        public override void OnAfterSerialize(Type storageType, object instance, ref fsData data, object other) {
            // Don't call the callback on null instances.
            if (instance == null) return;
            ((fsISerializationCallbacks)instance).OnAfterSerialize(storageType, ref data);
        }

        public override void OnBeforeDeserializeAfterInstanceCreation(Type storageType, object instance, ref fsData data, object other) {
        ...
        public override void OnAfterDeserialize(Type storageType, object instance, object other) {
            // Don't call the callback on null instances.
            if (instance == null) return;
