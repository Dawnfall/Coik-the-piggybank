...
namespace aim.FullSerializer
{
    public class fsSerializer
    {
        ...
        private static void Invoke_OnBeforeSerialize(List<fsObjectProcessor> processors, Type storageType, object instance, object other)
        {
            for (int i = 0; i < processors.Count; ++i)
            {
                processors[i].OnBeforeSerialize(storageType, instance, other);
            }
        }
        private static void Invoke_OnAfterSerialize(List<fsObjectProcessor> processors, Type storageType, object instance, ref fsData data, object other)
        {
            ...
            {
                processors[i].OnAfterSerialize(storageType, instance, ref data, other);
            }
        }
        private static void Invoke_OnBeforeDeserialize(List<fsObjectProcessor> processors, Type storageType, ref fsData data, object other)
        {
            for (int i = 0; i < processors.Count; ++i)
            {
                processors[i].OnBeforeDeserialize(storageType, ref data, other);
            }
        }
        private static void Invoke_OnBeforeDeserializeAfterInstanceCreation(List<fsObjectProcessor> processors, Type storageType, object instance, ref fsData data, object other)
        {
            for (int i = 0; i < processors.Count; ++i)
            {
                processors[i].OnBeforeDeserializeAfterInstanceCreation(storageType, instance, ref data, other);
            }
        }
        private static void Invoke_OnAfterDeserialize(List<fsObjectProcessor> processors, Type storageType, object instance, object other)
        {
            for (int i = processors.Count - 1; i >= 0; --i)
            {
                processors[i].OnAfterDeserialize(storageType, instance, other);
            }
        }
        ...
        /// </summary>
        public fsResult TrySerialize<T>(T instance, out fsData data, object other)
        {
            return TrySerialize(typeof(T), instance, out data, other);
        }
        ...
        public fsResult TrySerialize(Type storageType, object instance, out fsData data, object other)
        {
            return TrySerialize(storageType, null, instance, out data, other);
        }
        ...
        /// <param name="data">The serialized state of the object.</param>
        /// <returns>If serialization was successful.</returns>
        public fsResult TrySerialize(Type storageType, Type overrideConverterType, object instance, out fsData data, object other)
        {
            var processors = GetProcessors(instance == null ? storageType : instance.GetType());

            Invoke_OnBeforeSerialize(processors, storageType, instance, other);

            // We always serialize null directly as null
            if (ReferenceEquals(instance, null))
            {
                data = new fsData();
                Invoke_OnAfterSerialize(processors, storageType, instance, ref data, other);
                return fsResult.Success;
            }

            var result = InternalSerialize_1_ProcessCycles(storageType, overrideConverterType, instance, out data, other);
            Invoke_OnAfterSerialize(processors, storageType, instance, ref data, other);
            return result;
        }

        private fsResult InternalSerialize_1_ProcessCycles(Type storageType, Type overrideConverterType, object instance, out fsData data, object other)
        {
            ...
            try
            {
                ...
                {
                    return InternalSerialize_2_Inheritance(storageType, overrideConverterType, instance, out data, other);
                }
                ...
                // correctly for us.
                var result = InternalSerialize_2_Inheritance(storageType, overrideConverterType, instance, out data, other);
        ...
        private fsResult InternalSerialize_2_Inheritance(Type storageType, Type overrideConverterType, object instance, out fsData data, object other)
        {
            ...
            var serializeResult = InternalSerialize_3_ProcessVersioning(overrideConverterType, instance, out data, other);
        ...
        private fsResult InternalSerialize_3_ProcessVersioning(Type overrideConverterType, object instance, out fsData data, object other)
        {
            ...
            if (optionalVersionedType.HasValue)
            {
                ...
                var result = InternalSerialize_4_Converter(overrideConverterType, instance, out data, other);
                if (result.Failed) return result;
            ...
            return InternalSerialize_4_Converter(overrideConverterType, instance, out data, other);
        }
        private fsResult InternalSerialize_4_Converter(Type overrideConverterType, object instance, out fsData data, object other)
        {
            var instanceType = instance.GetType();
            return GetConverter(instanceType, overrideConverterType).TrySerialize(instance, out data, instanceType, other);
        }

        /// <summary>
        /// Generic wrapper around TryDeserialize that simply forwards the call.
        /// </summary>
        public fsResult TryDeserialize<T>(fsData data, ref T instance, object other)
        {
            object boxed = instance;
            var fail = TryDeserialize(data, typeof(T), ref boxed, other);
            if (fail.Succeeded)
            {
                instance = (T)boxed;
            }
        ...
        /// </summary>
        public fsResult TryDeserialize(fsData data, Type storageType, ref object result, object other)
        {
            return TryDeserialize(data, storageType, null, ref result, other);
        }
        /// <summary>
        /// Attempts to deserialize a value from a serialized state.
        /// </summary>
        public fsResult TryDeserialize(fsData data, Type storageType, Type overrideConverterType, ref object result, object other)
        {
            if (data.IsNull)
            {
                result = null;
                var processors = GetProcessors(storageType);
                Invoke_OnBeforeDeserialize(processors, storageType, ref data, other);
                Invoke_OnAfterDeserialize(processors, storageType, null, other);
                return fsResult.Success;
            }
            ...
            try
            {
                ...
                List<fsObjectProcessor> processors;
                var r = InternalDeserialize_1_CycleReference(overrideConverterType, data, storageType, ref result, out processors,other);
                if (r.Succeeded)
                {
                    Invoke_OnAfterDeserialize(processors, storageType, result, other);
                }
                return r;
            }
            finally
        ...
        private fsResult InternalDeserialize_1_CycleReference(Type overrideConverterType, fsData data, Type storageType, ref object result, out List<fsObjectProcessor> processors, object other)
        {
            ...
            return InternalDeserialize_2_Version(overrideConverterType, data, storageType, ref result, out processors, other);
        }
        private fsResult InternalDeserialize_2_Version(Type overrideConverterType, fsData data, Type storageType, ref object result, out List<fsObjectProcessor> processors, object other)
        {
            if (IsVersioned(data))
            {
                    ...
                    versionedType.Value.VersionString != version)
                {
                    ...
                    deserializeResult += InternalDeserialize_3_Inheritance(overrideConverterType, data, path[0].ModelType, ref result, out processors, other);
            ...
            return InternalDeserialize_3_Inheritance(overrideConverterType, data, storageType, ref result, out processors, other);
        }
        private fsResult InternalDeserialize_3_Inheritance(Type overrideConverterType, fsData data, Type storageType, ref object result, out List<fsObjectProcessor> processors, object other)
        {
            var deserializeResult = fsResult.Success;
            ...
            // existing instance.
            Invoke_OnBeforeDeserializeAfterInstanceCreation(processors, storageType, result, ref data, other);
            ...
            return deserializeResult += InternalDeserialize_4_Cycles(overrideConverterType, data, objectType, ref result,other);
        }
        private fsResult InternalDeserialize_4_Cycles(Type overrideConverterType, fsData data, Type resultType, ref object result, object other)
        {
            if (IsObjectDefinition(data))
            {
            ...
            return InternalDeserialize_5_Converter(overrideConverterType, data, resultType, ref result,other);
        }
        private fsResult InternalDeserialize_5_Converter(Type overrideConverterType, fsData data, Type resultType, ref object result, object other)
        {
            ...
            return GetConverter(resultType, overrideConverterType).TryDeserialize(data, ref result, resultType, other);
        }
    }
}