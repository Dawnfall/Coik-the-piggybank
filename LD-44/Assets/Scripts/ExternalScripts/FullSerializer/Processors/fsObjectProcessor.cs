...
namespace aim.FullSerializer
{
    ...
    public abstract class fsObjectProcessor
    {
        ...
        public virtual void OnBeforeSerialize(Type storageType, object instance, object other) { }
        ...
        public virtual void OnAfterSerialize(Type storageType, object instance, ref fsData data, object other) { }
        ...
        /// </param>
        public virtual void OnBeforeDeserialize(Type storageType, ref fsData data, object other) { }
        ...
        /// The data that will be used for deserialization.
        /// </param>
        public virtual void OnBeforeDeserializeAfterInstanceCreation(Type storageType, object instance, ref fsData data, object other) { }
        ...
        /// </param>
        /// <param name="instance">The type of the instance.</param>
        public virtual void OnAfterDeserialize(Type storageType, object instance, object other) { }
    }
}